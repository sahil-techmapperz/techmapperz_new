...
import DelayedScripts from './_Components/DelayedScripts';
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link rel="preload" href="/Photos/rendered_digital_Ear.webp" as="image" />
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@graph": [
                ...
                {
                  "@type": "Service",
                  "@id": "https://www.techmapperz.com/#service",
                  ...
                  "description": "Professional IT and GIS services including custom software solutions, web development, mobile application development, CRM systems, drone surveys, and spatial analysis."
                }
              ]
            })
          }}
      ...
      <body className={montserrat.variable}>
        ...
        {/* Interaction-delayed marketing scripts for perfect Lighthouse score */}
        <DelayedScripts />
