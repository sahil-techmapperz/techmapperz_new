        ...
        if (Object.keys(validationErrors).length > 0) {
            ...
            fetch(`/api/contact`, {
                ...
                .then((res) => {
                    if (res.status === 200) {
                        setFormData(init);
                        alert("Request Submitted! Thank you for your request. We will get back to you shortly.");
                        closeForm();
                        
                    } else {
                        
                        alert("Submission Failed: Unable to submit your request. Please try again.");
                    }
                })
                .catch((err) => {
