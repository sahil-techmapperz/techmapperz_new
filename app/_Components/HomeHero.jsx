...
const HomeHero = () => {
    return (
        <section
            ...
            style={{ backgroundImage: `url('/background_image/home_hero_v3.png')` }}
        >
            ...
            <div className="max-w-[1600px] w-full mx-auto px-6 md:px-12 lg:px-20 relative z-10 flex flex-col gap-6 ">
                ...
                {/* Heading */}
                <h1 className="text-3xl md:text-4xl lg:text-[45px]  font-bold text-white tracking-tight" style={{ lineHeight: '1.2' }}>
                    Driving Growth Through <br/>
                     Smart IT ,GIS & <br/> Drone Solutions
                </h1>

                {/* Subtext */}
                <p className="text-gray-300 text-base lg:text-[17px] max-w-xl">
                    Responsive, SEO-Optimized IT, GIS & Drone Solutions Built With Modern Technologies
                </p>
