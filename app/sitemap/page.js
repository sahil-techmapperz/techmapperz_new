  ...
  const sections = [
    ...
    },
    {
      ...
      links: [
        {
          name: 'GIS Services',
          href: '/service/gis-services',
          subLinks: [
            { name: 'GIS Mapping', href: '/service/gis-services/gis-mapping' },
            { name: 'Data Digitization', href: '/service/gis-services/data-digitization' },
            { name: 'GIS Consulting', href: '/service/gis-services/gis-consulting' },
            { name: 'Web GIS Development', href: '/service/gis-services/web-gis-development' },
            { name: 'GIS Surveying', href: '/service/gis-services/gis-surveying' },
          ]
        },
        {
          name: 'Drone Services',
          href: '/service/drone-services',
          subLinks: [
            { name: 'Drone Survey and Mapping', href: '/service/drone-services/drone-survey-and-mapping' },
            { name: 'Inspection and Analysis', href: '/service/drone-services/inspection-and-analysis' },
            { name: 'Drone Data Processing', href: '/service/drone-services/drone-data-processing' },
          ]
        },
      ]
    },
    {
      ...
      mainLink: '/service',
      links: [
        { name: 'Mobile App Development', href: '/service/it-services/mobile-development' },
        { name: 'Website Development', href: '/service/it-services/web-development' },
        { name: 'CRM Software Solution', href: '/service/it-services/crm' },
        { name: 'IT Consultancy', href: '/service/it-services/it-consulting' },
      ]
    },
    {
      title: 'Resources',
