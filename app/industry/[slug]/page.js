	...
	return (
		<div className="min-h-screen bg-black">
			<BreadcrumbJsonLd items={[
				{ name: 'Home', url: process.env.NEXT_PUBLIC_BASE_URL || "https://www.techmapperz.com" },
				{ name: 'Industries', url: `${process.env.NEXT_PUBLIC_BASE_URL || "https://www.techmapperz.com"}/industry` },
				{ name: industry.name, url: `${process.env.NEXT_PUBLIC_BASE_URL || "https://www.techmapperz.com"}/industry/${params.slug}` }
			]} />
			{/* Hero Header Section */}
